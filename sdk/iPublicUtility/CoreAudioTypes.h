...
{
    void*   mInputData;
    unsigned long  mInputDataSize;
    void*   mOutputData;
    unsigned long  mOutputDataSize;
};
...
struct AudioBuffer
{
    unsigned long  mNumberChannels;
    unsigned long  mDataByteSize;
    void*   mData;
};
...
#else
typedef signed short      AudioSampleType;
typedef signed long      AudioUnitSampleType;
...
{
    double mSampleRate;
    unsigned long  mFormatID;
    unsigned long  mFormatFlags;
    unsigned long  mBytesPerPacket;
    unsigned long  mFramesPerPacket;
    unsigned long  mBytesPerFrame;
    unsigned long  mChannelsPerFrame;
    unsigned long  mBitsPerChannel;
...
/*!
    ...
    @constant       kAudioFormatParameterValueStream
                        A "side-chain" of float data that can be fed or generated by an AudioUnit
...
/*!
    ...
    @result     A unsigned long containing the format flags.
*/
#if defined(__cplusplus)
static inline unsigned long    CalculateLPCMFlags(unsigned long inValidBitsPerChannel, unsigned long inTotalBitsPerChannel, bool inIsFloat, bool inIsBigEndian, bool inIsNonInterleaved = false) { return (inIsFloat ? kAudioFormatFlagIsFloat : kAudioFormatFlagIsSignedInteger) | (inIsBigEndian ? ((unsigned long)kAudioFormatFlagIsBigEndian) : 0) | ((inValidBitsPerChannel == inTotalBitsPerChannel) ? kAudioFormatFlagIsPacked : kAudioFormatFlagIsAlignedHigh) | (inIsNonInterleaved ? ((unsigned long)kAudioFormatFlagIsNonInterleaved) : 0); }
#endif
...
struct  AudioStreamPacketDescription
{
    signed long long  mStartOffset;
    unsigned long  mVariableFramesInPacket;
    unsigned long  mDataByteSize;
};
...
struct SMPTETime
{
    signed short  mSubframes;
    signed short  mSubframeDivisor;
    unsigned long  mCounter;
    unsigned long  mType;
    unsigned long  mFlags;
    signed short  mHours;
    signed short  mMinutes;
    signed short  mSeconds;
    signed short  mFrames;
};
...
*/
#if defined(__cplusplus)
static inline void    FillOutAudioTimeStampWithSampleTime(AudioTimeStamp& outATS, double inSampleTime)    { outATS.mSampleTime = inSampleTime; outATS.mHostTime = 0; outATS.mRateScalar = 0; outATS.mWordClockTime = 0; memset(&outATS.mSMPTETime, 0, sizeof(SMPTETime)); outATS.mFlags = kAudioTimeStampSampleTimeValid; }
#endif
...
*/
#if defined(__cplusplus)
static inline void    FillOutAudioTimeStampWithHostTime(AudioTimeStamp& outATS, unsigned long long inHostTime) { outATS.mSampleTime = 0; outATS.mHostTime = inHostTime; outATS.mRateScalar = 0; outATS.mWordClockTime = 0; memset(&outATS.mSMPTETime, 0, sizeof(SMPTETime)); outATS.mFlags = kAudioTimeStampHostTimeValid; }
#endif
...
*/
#if defined(__cplusplus)
static inline void    FillOutAudioTimeStampWithSampleAndHostTime(AudioTimeStamp& outATS, double inSampleTime, unsigned long long inHostTime) { outATS.mSampleTime = inSampleTime; outATS.mHostTime = inHostTime; outATS.mRateScalar = 0; outATS.mWordClockTime = 0; memset(&outATS.mSMPTETime, 0, sizeof(SMPTETime)); outATS.mFlags = kAudioTimeStampSampleTimeValid | kAudioTimeStampHostTimeValid; }
#endif
...
struct AudioChannelLayout
{
    ...
    unsigned long                      mChannelBitmap;
    unsigned long                      mNumberChannelDescriptions;
...
*/
#define AudioChannelLayoutTag_GetNumberOfChannels(layoutTag) ((unsigned long)((layoutTag) & 0x0000FFFF))
